...
The following is taken from [repo](https://github.com/jwasham/coding-interview-university/blob/main/README.md)
...
- ### Queue
    ...
    - [ ] Implement using fixed-sized array:
        ...
        - full()
    - [x] Cost:
        - If implemented using a doubly_linked_list, one can always reduce the below time-complexity
